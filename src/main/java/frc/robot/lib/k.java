...
public final class k {
  ...
  public static class DRIVEBASE {
    ...
    public static final double TURN_KP = 10.0;
  ...
  public static class DRIVE {
    ...
    private static final double MOTOR_PINION_TEETH = 14.0;
    private static final double GEAR_1_TEETH = 14.0;
    private static final double GEAR_2_DRIVE_TEETH = 10.0;
    private static final double GEAR_2_DRIVEN_TEETH = 22.0;
    ...
    private static final double MOTOR_PEAK_EFFICIENCY_percent = 100.0;
  ...
  public static class STEER {
    ...
    private static final double MOTOR_DRIVE_GEAR_TEETH = 16.0;
    private static final double GEAR_1_DRIVE_TEETH = 8.0;
    private static final double GEAR_1_DRIVEN_TEETH = 46.0;
    private static final double CANCODER_GEAR_RATIO = 4.0;
    ...
    public static final double PID_Kp = 0.3;
    public static final double PID_Ki = 0.3;
    public static final double PID_MaxV = 0.05;
    public static final double PID_MaxA = 0.05;
